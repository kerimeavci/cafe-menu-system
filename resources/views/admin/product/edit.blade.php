...
@section('title', "Admin Ürün Düzenle")
            ...
            <div class="form-container">
                ...
                <form action="{{ route('product_edit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control"  name="slug" type="text" value="{{ $products->slug }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="category" name="category">
                            @foreach($main_categories as $main_category)
                                <option value="{{ $main_category->id }}" {{ old('category') == $main_category->id ? 'selected' : '' }}>{{ $main_category->description }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn ripple btn-primary">Ürün Değiştir</button>
                    </div>
                </form>
            </div>
        </div>
